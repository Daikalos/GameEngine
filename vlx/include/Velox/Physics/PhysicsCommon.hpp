...
namespace vlx
{
	...
	inline constexpr float P_VEL_SLEEP_TOLERANCE_SQR	= au::Sqr(P_VEL_SLEEP_TOLERANCE);
	inline constexpr float P_ANG_SLEEP_TOLERANCE_SQR	= au::Sqr(P_ANG_SLEEP_TOLERANCE);
