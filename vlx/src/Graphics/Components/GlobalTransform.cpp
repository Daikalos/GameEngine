...
const Mat4f& GlobalTransform::GetTransform() const noexcept
{
	return m_transform;
}
const Mat4f& GlobalTransform::GetInverseTransform() const
{
	if (m_update_inverse)
	{
...
const Vector2f& GlobalTransform::GetPosition() const 
{
...
const Vector2f& GlobalTransform::GetScale() const 
{
	if (m_update_scale)
	{
...
const sf::Angle& GlobalTransform::GetRotation() const 
{
